...
const Login: React.FC = () => {
  ...
  const handleSubmit = async (values: API.LoginParams) => {
    try {
      ...
      values.crypt_key = crypto.rsa_key_encrypt();
      setType(values.type);
      if (values.type === 'account') {
        ...
        values.email = crypto.aes_encrypt(values?.email);
      }
    ...
    <div className={containerClassName}>
      ...
      >
        ...
        >
          ...
          {errcode !== undefined && type === 'account' && (
            <LoginMessage
          ...
          {errcode !== undefined && type === 'mobile' && <LoginMessage content="验证码错误" />}
          {type === 'mobile' && (
            <>
              <ProFormText
                fieldProps={{
